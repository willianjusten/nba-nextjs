  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: "absolute left-1 top-[2px] z-10 h-8 w-8 bg-transparent p-0 opacity-50 hover:opacity-100 flex items-center justify-center cursor-pointer",
        button_next: "absolute right-1 top-[2px] z-10 h-8 w-8 bg-transparent p-0 opacity-50 hover:opacity-100 flex items-center justify-center cursor-pointer",
        ...
        day_button: "size-8 p-0 font-normal flex items-center justify-center rounded-md transition-colors cursor-pointer",
